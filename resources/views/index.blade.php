...
<head>
    <meta charset="utf-8">
    <title>MathSharingFrontend</title>
    <base href="/">
    ...
    <style type="text/css">@font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url(https://fonts.gstatic.com/s/materialicons/v117/flUhRq6tzZclQEJ-Vdg-IuiaDsNa.woff) format('woff');
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url(https://fonts.gstatic.com/s/materialicons/v117/flUhRq6tzZclQEJ-Vdg-IuiaDsNcIhQ8tQ.woff2) format('woff2');
        }
    ...
    <link rel="stylesheet" href="angular/styles.css" media="print" onload="this.media='all'">
    <noscript>
...
<app-root></app-root>
<script src="angular/runtime-es2017.js" type="module"></script>
<script src="angular/runtime-es5.js" nomodule defer></script>
<script src="angular/polyfills-es5.js" nomodule defer></script>
<script src="angular/polyfills-es2017.js" type="module"></script>
<script src="angular/main-es2017.js" type="module"></script>
<script src="angular/main-es5.js" nomodule defer></script>
